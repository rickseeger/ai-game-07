...
def main():
    ...
    run([python, "tools/mission_sim.py", "--output", str(out / "mission-sim")], out / "mission-sim.log", env)
    run([python, "tools/mission_runtime.py", "--output", str(out / "mission-runtime")], out / "mission-runtime.log", env, timeout=300)
